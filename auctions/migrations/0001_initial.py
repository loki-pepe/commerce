# Generated by Django 4.2.2 on 2023-07-21 12:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_price', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(limit_value=0)])),
                ('category', models.CharField(choices=[('AC', 'All Categories'), ('CL', 'Clothing'), ('SP', 'Sports'), ('HM', 'Home'), ('TH', 'Toys and Hobbies'), ('BS', 'Business'), ('HB', 'Health and Beauty'), ('PS', 'Pet Supplies'), ('EL', 'Electronics'), ('AR', 'Art'), ('BM', 'Books, Movies, and Music')], default='All Categories', max_length=2)),
                ('image', models.URLField(blank=True, null=True)),
                ('active_status', models.BooleanField(default=True)),
                ('buyer', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='bought_listings', to=settings.AUTH_USER_MODEL)),
